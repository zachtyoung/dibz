    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section style={{ borderBottom: `2px solid ${INK}` }}>
        ...
        <div className="grid md:grid-cols-3" style={{ borderBottom: `2px solid ${INK}` }}>
          ...
          <HowStep n="03" icon={<DollarSign className="h-5 w-5" />} title="Score it" body="List anything for free. No fees ever. Just neighbors buying and selling." href="/dashboard?new=1" />
        </div>
      </section>
