      ...
      <div style={{ width: "100%", maxWidth: 400, border: `2px solid ${INK}`, background: "white", boxShadow: `6px 6px 0 ${INK}`, padding: "2rem" }}>
        ...
        <form action={signUp} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontFamily: MONO, fontSize: 10, textTransform: "uppercase", letterSpacing: "0.12em", color: INK }}>Name</span>
            <input
              name="name"
              type="text"
              required
        ...
        <p style={{ fontFamily: MONO, fontSize: 11, color: INK, opacity: 0.7, marginTop: "1.5rem", textAlign: "center" }}>
          ...
          <Link href="/auth/login" style={{ color: INK, fontWeight: 700, textDecoration: "underline" }}>
            Sign in
          </Link>
        </p>
      </div>
